...
typedef char (*match_cb_t)(struct response_cache *rc, void *key, struct crtx_event *event, struct response_cache_entry *c_entry);
typedef void (*hit_cb_t)(struct response_cache_task *ct, void **key, struct crtx_event *event, struct response_cache_entry *c_entry);
typedef void (*miss_cb_t)(struct response_cache_task *ct, void **key, struct crtx_event *event);
